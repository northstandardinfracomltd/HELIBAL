...
export default function Hero({ t, seoCity, currentLang }: HeroProps) {
  const bgImage = "https://civilprom.s3.eu-north-1.amazonaws.com/HeliBaleares+-+Hero+Helico.png";
  ...
  return (
    <section 
      id="hero" 
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black pt-24 sm:pt-20"
    >
        ...
        <div className="max-w-3xl">
          ...
          >
            <a 
              ...
              className="inline-flex items-center gap-2 text-sm sm:text-base font-sans font-medium text-white hover:text-white transition-colors bg-black/60 hover:bg-[#721489]/80 border border-white/20 hover:border-[#ffdd10]/80 px-4.5 py-2.5 rounded-full backdrop-blur-md shadow-sm transition-all duration-200 cursor-pointer"
              id="hero-instagram-badge"
            >
              <Instagram className="h-5 w-5 text-[#ffdd10]" />
