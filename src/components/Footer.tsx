          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <div className="pt-1">
              <a 
                ...
                className="inline-flex items-center gap-2 bg-[#721489] hover:bg-[#5b106e] text-white text-xs font-sans font-medium py-2.5 px-4 rounded-full transition-all duration-200 shadow-xs active:scale-98"
                id="footer-instagram-link"
              >
                <Instagram className="h-4 w-4 text-[#ffdd10]" />
